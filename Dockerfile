...
##</autogenerated>##
RUN apt-get update && apt-get -y install libmysqlclient-dev libpspell-dev librecode-dev libbz2-dev libcurl4-gnutls-dev libvpx-dev libjpeg-dev libpng-dev --no-install-recommends && rm -r /var/lib/apt/lists/*
