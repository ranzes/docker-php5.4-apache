...
##<autogenerated>##
RUN apt-get update && apt-get install -y openssl-dev libcurl4-openssl-dev pkg-config libjpeg-dev libpng-dev libfreetype6-dev libgmp-dev libmcrypt-dev apache2 --no-install-recommends && rm -rf /var/lib/apt/lists/*
