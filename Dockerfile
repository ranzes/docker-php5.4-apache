...
##<autogenerated>##
RUN apt-get update && apt-get install -y open-ssl-dev libcurl4-openssl-dev pkg-config libjpeg-dev libpng-dev libfreetype6-dev libgmp-dev libmcrypt-dev apache2 --no-install-recommends && rm -rf /var/lib/apt/lists/*
...
##</autogenerated>##
RUN apt-get update && apt-get -y install libmysqlclient15-dev libpspell-dev librecode-dev libbz2-dev libcurl4-gnutls-dev libvpx-dev libjpeg-dev libpng-dev --no-install-recommends && rm -r /var/lib/apt/lists/*
